...
const GLfloat MAXIMUM_VIEWER_DISTANCE    = 100;
const GLfloat MINIMUM_VIEWER_DISTANCE    = 2;
const GLfloat INITIAL_VIEWER_DISTANCE    = 45;
...
const char ASTEROID1_BMP_FILENAME[] = "Bitmaps/asteroid1.bmp";
const char ASTEROID2_BMP_FILENAME[] = "Bitmaps/asteroid2.bmp";
const char ASTEROID3_BMP_FILENAME[] = "Bitmaps/asteroid3.bmp";

const char SKYBOX_BMP_FILENAME_FRONT[] = "Bitmaps/front.bmp"; 
const char SKYBOX_BMP_FILENAME_LEFT[] = "Bitmaps/left.bmp";
const char SKYBOX_BMP_FILENAME_BACK[] = "Bitmaps/back.bmp";
const char SKYBOX_BMP_FILENAME_RIGHT[] = "Bitmaps/right.bmp";
const char SKYBOX_BMP_FILENAME_TOP[] = "Bitmaps/top.bmp";
const char SKYBOX_BMP_FILENAME_BOTTOM[] = "Bitmaps/bottom.bmp";
...
const GLfloat MERCURY_ORBIT_RADIUS = SUN_RADIUS + .39;
const GLfloat VENUS_ORBIT_RADIUS =   SUN_RADIUS + MERCURY_RADIUS + .72;
const GLfloat MARS_ORBIT_RADIUS =    SUN_RADIUS + MERCURY_RADIUS + VENUS_RADIUS + EARTH_RADIUS + 1.52;
const GLfloat JUPITER_ORBIT_RADIUS = SUN_RADIUS + MERCURY_RADIUS + VENUS_RADIUS + EARTH_RADIUS + MARS_RADIUS + 5.20;
const GLfloat SATURN_ORBIT_RADIUS = SUN_RADIUS + MERCURY_RADIUS + VENUS_RADIUS + EARTH_RADIUS + MARS_RADIUS + JUPITER_RADIUS + 9.54;
const GLfloat URANUS_ORBIT_RADIUS = SUN_RADIUS + MERCURY_RADIUS + VENUS_RADIUS + EARTH_RADIUS + MARS_RADIUS + JUPITER_RADIUS + SATURN_RADIUS + 19.2;
const GLfloat NEPTUNE_ORBIT_RADIUS = SUN_RADIUS + MERCURY_RADIUS + VENUS_RADIUS + EARTH_RADIUS + MARS_RADIUS + JUPITER_RADIUS + SATURN_RADIUS + URANUS_RADIUS + 30.1;
const GLfloat PLUTO_ORBIT_RADIUS = SUN_RADIUS + MERCURY_RADIUS + VENUS_RADIUS + EARTH_RADIUS + MARS_RADIUS + JUPITER_RADIUS + SATURN_RADIUS + URANUS_RADIUS + NEPTUNE_RADIUS + 39.4;
const GLfloat EARTH_ORBIT_RADIUS = SUN_RADIUS + MERCURY_RADIUS + VENUS_RADIUS + 1.0;
...
const GLfloat MERCURY_INCLINATION = 7 * TO_RADIANS;
const GLfloat VENUS_INCLINATION   = 3.39 * TO_RADIANS;
const GLfloat MARS_INCLINATION    = 1.85 * TO_RADIANS;
const GLfloat JUPITER_INCLINATION = 1.3 * TO_RADIANS;
const GLfloat SATURN_INCLINATION  = 2.49 * TO_RADIANS;
const GLfloat URANUS_INCLINATION  = .77 * TO_RADIANS;
const GLfloat NEPTUNE_INCLINATION = 1.77 * TO_RADIANS;
const GLfloat PLUTO_INCLINATION   = 17.2 * TO_RADIANS;
const GLfloat EARTH_INCLINATION   = 0 * TO_RADIANS;
